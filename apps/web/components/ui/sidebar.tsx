    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // width only: animating box-shadow too makes WebKit drop the layer mid-reveal and leave stale paint.
          usesHoverReveal
            ? "overflow-hidden transition-[width] duration-200 ease-linear motion-reduce:transition-none group-data-[state=collapsed]:w-(--sidebar-width-icon)"
